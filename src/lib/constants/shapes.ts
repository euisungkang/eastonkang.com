...
const shapes = [
	...
	},
	{
		...
		transitions: [
			'invisible',
			'invisible',
			// 'translate-y-[-2.5%] scale-x-[715%] scale-y-[.25] z-10 bg-linear-to-r from-[#F8B3CA] via-[#8E7AB5] to-[#F8B3CA]',
			'invisible',
			'invisible',
			// 'translate-x-[-125%] translate-y-[-52.5%] scale-x-[.25] scale-y-[400%] z-10 bg-linear-to-t from-[#8E7AB5] to-[#F8B3CA] border-r-0 border-white',
